...
import org.jiwan.javapractice.messenger.model.Comment;
import org.jiwan.javapractice.messenger.service.CommentService;
...
public class CommentResource {
	...
	@POST
	@Path("/{commentId}")
	public Comment addCommentById(@PathParam("messageId") long messageId,Comment comment){
